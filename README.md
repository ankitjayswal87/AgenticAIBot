...
For, testing agent with skill and memory
```
curl -X POST 'http://localhost:5006/agentic_ai/agent_with_skill_memory' --header 'Content-Type: application/json' --data-raw '{"thread_id":"test123","query":"what are AI usecases in telephony","model":"openai"}'
```
